...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	@Query("SELECT DISTINCT(mu.id), mu.name, mu.price, COUNT(mu.id) FROM Order o INNER JOIN o.menus mu WHERE o.isPaid = false AND o.username = :username GROUP BY mu.id")
